...
int main(int argc, char** argv){
  ...
  std::string override_config_file  = FLAGS_default_c.c_str();
  std::string default_config_file   = FLAGS_override_c.c_str();
  ...
  caffe::Frcnn::FrcnnParam::load_param(override_config_file, default_config_file);
  ...
  caffe::Timer time_;
  LOG(INFO) << "Test Image Dir : " << image_dir << "   , have " << images.size() << " pictures!";
